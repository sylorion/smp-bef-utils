 ...
 */
export function authenticationMiddlewareBuilder(userDetailService, scopedRoleService) {
    return async (req, res, next) => {
        ...
        if (!userToken || !userToken.startsWith('Bearer ')) {
            ...
            if (token) {
                ...
                const userRoles = userDetailService ? await userDetailService(userID) : undefined;
 ...
 */
export async function scopedRoleServiceController(userID) {
    const orgRoles = await getOrgRolesFromOrgService(userID);
